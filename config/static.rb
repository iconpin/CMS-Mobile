module CMS
  module Static
    ...
    EXTRA_XML_DATA = %(<PoI NameId="XEMENEIES">
  ...
  <GPSPoint latitude="41.565561" longitude="2.007657">
    </GPSPoint>
    <RA has="true" imagePath="XEMENEIES">
    </RA>
  </PoI>
  <Text 	id="XEMENEIES"
      cat="Xemeneies RA"
  ...
  <Text 	id="mnactecMuseum"
      ...
      cast="El Museu de la Ciència i de la Tècnica de Catalunya enceta aquest any 2013 una nova etapa després d'una llarga i fructífera història de més de 30 anys d'existència amb el seu anterior director, Eusebi Casanelles al capdavant d'aquesta destacada institució cultural catalana."
